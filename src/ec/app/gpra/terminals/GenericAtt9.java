...
public class GenericAtt9 extends GPNode{

    public String toString() { return "gd9"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[9];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(9); //TODO pode ser que eu use um vetor na classe de 
