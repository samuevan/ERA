...
public class GenericAtt6 extends GPNode{

    public String toString() { return "gd6"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[6];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(6); //TODO pode ser que eu use um vetor na classe de 
