...
public class GenericAtt8 extends GPNode{

    public String toString() { return "gd8"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[8];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(8); //TODO pode ser que eu use um vetor na classe de 
