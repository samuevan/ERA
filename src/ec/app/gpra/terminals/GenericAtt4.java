...
public class GenericAtt4 extends GPNode{

    public String toString() { return "gd4"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[4];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(4); //TODO pode ser que eu use um vetor na classe de 
