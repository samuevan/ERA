...
public class GenericAtt16 extends GPNode{

    public String toString() { return "gd16"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[16];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(16); //TODO pode ser que eu use um vetor na classe de 
