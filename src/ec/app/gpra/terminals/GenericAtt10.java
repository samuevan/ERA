...
public class GenericAtt10 extends GPNode{

    public String toString() { return "gd10"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[10];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(10); //TODO pode ser que eu use um vetor na classe de 
