...
public class GenericAtt13 extends GPNode{

    public String toString() { return "gd13"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[13];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(13); //TODO pode ser que eu use um vetor na classe de 
