...
public class GenericAtt1 extends GPNode{

    public String toString() { return "gd1"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[1];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(1); //TODO pode ser que eu use um vetor na classe de 
