...
public class GenericAtt18 extends GPNode{

    public String toString() { return "gd18"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[18];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(18); //TODO pode ser que eu use um vetor na classe de 
