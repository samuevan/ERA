...
public class GenericAtt5 extends GPNode{

    public String toString() { return "gd5"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[5];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(5); //TODO pode ser que eu use um vetor na classe de 
