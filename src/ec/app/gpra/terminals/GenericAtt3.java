...
public class GenericAtt3 extends GPNode{

    public String toString() { return "gd3"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[3];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(3); //TODO pode ser que eu use um vetor na classe de 
