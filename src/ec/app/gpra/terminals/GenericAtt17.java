...
public class GenericAtt17 extends GPNode{

    public String toString() { return "gd17"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[17];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(17); //TODO pode ser que eu use um vetor na classe de 
