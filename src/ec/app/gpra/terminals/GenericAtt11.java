...
public class GenericAtt11 extends GPNode{

    public String toString() { return "gd11"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[11];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(11); //TODO pode ser que eu use um vetor na classe de 
