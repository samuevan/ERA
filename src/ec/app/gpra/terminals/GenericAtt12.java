...
public class GenericAtt12 extends GPNode{

    public String toString() { return "gd12"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[12];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(12); //TODO pode ser que eu use um vetor na classe de 
