...
public class GenericAtt19 extends GPNode{

    public String toString() { return "gd19"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[19];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(19); //TODO pode ser que eu use um vetor na classe de 
