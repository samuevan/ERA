...
public class GenericAtt7 extends GPNode{

    public String toString() { return "gd7"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[7];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(7); //TODO pode ser que eu use um vetor na classe de 
