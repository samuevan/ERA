...
public class GenericAtt14 extends GPNode{

    public String toString() { return "gd14"; }
...
*/
			...
			final GPIndividual individual, final Problem problem) 
	{
		...
		rd.x = ((GPRA_Problem) problem).genericDoubles[14];
		//rd.x = ((GPRA_Problem) problem).genericDoubles.get(14); //TODO pode ser que eu use um vetor na classe de 
